...
1. **Client** (`tap_restcountries/client.py`): Handles API communication and authentication
1. **Streams** (`tap_restcountries/streams.py`): Define data streams and their schemas
